...
public class Myadapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>implements View.OnClickListener{
    ...
    Context context;
    public Myadapter(Context context, List<FenLeiBean.RetBean.ListBean> list) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        mv.tv_head.setText(list.get(position).getTitle().toString());
    ...
    public class MySearch_viewHolder extends RecyclerView.ViewHolder{
        ...
        public MySearch_viewHolder(View itemView) {
            super(itemView);
            tv_name=itemView.findViewById(R.id.text_dis);
            tv_head=itemView.findViewById(R.id.text_head);
